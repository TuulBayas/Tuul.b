...
guests = {'201': 'Tuul', '202': 'Max', '203':'Jack'}
correct_info = False
...
# Starter Order
starters = ['Fried Chicken', 'onion Rings', 'Mongolian Dumplings']
...
# Main Course Order
main = ['Steak', 'Pizza', 'Spicy Pork']
print("Choose your main dish:")
...
# Dessert Order
desserts = ['Ice Cream', 'Chocolate Lava Cake', 'Cremebrulee']
print("Today, we have these desserts:")
...
if order_confirm.lower() == 'yes':
    print("Thank you for your order! I hope you enjoy your food!")
else:
